...
p1 = Product.create([categories:products[1][:categories],title:products[1][:title],description:products[1][:description],quantity:10,price:21800])
...
p4 = Product.create([categories:products[3][:categories],title:products[3][:title],description:products[3][:description],quantity:10,price:36800])
p5 = Product.create([categories:products[4][:categories],title:products[4][:title],description:products[4][:description],quantity:19,price:12800])
